...
if __name__ == "__main__":
    ...
    env.set_meta_information(env_info = 'ANN glide path control Player')
    env.set_meta_information(model_discriminator = SAVED_MODEL_DISCRIMINATOR)

    if ENABLE_PARALLEL_PID:
        env_pid.set_meta_information(env_info = 'PID glide path control Player')
